...
function SearchResults({ searchTerm, backgroundImage, setBackgroundImage }) {
  ...
  useEffect(() => {
    if (resultsData.length === 0) {
      if (searchTerm.startsWith("appid:")) {
        let appid = searchTerm.split(":")[1];
  ...
  }, [searchTerm, setLoading, resultsData]);
